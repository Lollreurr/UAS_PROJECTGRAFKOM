...
public class TriangleCircle extends Object2d{
    ...
    public TriangleCircle(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f centerPoint,
        ...
        float x, y, z = 0;
        angle = angle + 90;
        for (double i=angle; i < 360+angle; i+=360/3){
